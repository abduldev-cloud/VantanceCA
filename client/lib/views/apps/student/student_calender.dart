import 'package:binary_success/controller/apps/student/student_calender_controller.dart';
...
class StudentCalenderPage extends StatefulWidget {
  ...
  @override
  StudentCalenderPageState createState() => StudentCalenderPageState();
}

class StudentCalenderPageState extends State<StudentCalenderPage>
    with SingleTickerProviderStateMixin, UIMixin {
  late StudentCalenderController controller;

  @override
  void initState() {
    super.initState();
    controller = Get.put(StudentCalenderController());
  }
  ...
  Widget build(BuildContext context) {
    return Layout(
      shrinkContent: true,
      selectedPage: 3,
      child: GetBuilder<StudentCalenderController>(
        builder: (controller) {
          return SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                MySpacing.height(35),
                MyCard(
                  width: MySpacing.fullWidth(context) * 0.75,
                  borderRadiusAll: 25,
                  marginAll: 8,
                  ...
                  child: Obx(
                    () => ScrollbarTheme(
                      ...
                      child: SfCalendar(
                        ...
                        dataSource:
                            _TaskDataSource(controller.appointments.value),
                        ...
                        // ✅ Month view settings (no appointmentHeight here)
                        monthViewSettings: const MonthViewSettings(
                          appointmentDisplayCount:
                              2, // Only 2 visible, rest shows +x more
                        ...
                        onTap: (CalendarTapDetails details) {
                          if (details.targetElement ==
                            ...
                            final String taskId =
                                tappedAppointment.id as String? ?? "";
                            if (taskId.isNotEmpty) {
                              Get.offNamed("/student/writingpad",
                                  arguments: taskId);
                            }
                          }
                        },

                        // ✅ Update month-year dynamically
                        onViewChanged: (ViewChangedDetails details) {
                          final DateTime visibleDate = details
  ...
  Widget appointmentBuilder(BuildContext context,
    ...
    final bool isMonthView =
        availableHeight < 80; // Month view cells are usually small
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Flexible(
                child: Text(
                  appointment.notes ?? 'Untitled Task',
                  maxLines: 1,
                  overflow: TextOverflow.ellipsis,
                  style: const TextStyle(
                    fontSize: 12,
