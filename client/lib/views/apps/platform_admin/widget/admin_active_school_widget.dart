...
class AdminActiveSchoolWidget extends StatelessWidget {
  final ContentTheme contentTheme;
  const AdminActiveSchoolWidget({super.key, required this.contentTheme});
      ...
      children: [
        ...
        Row(
          children: [
            ...
            //             width: 1, strokeAlign: 0, color: const Color(0xffE1E1E1)),
            //       ),
            ...
            //       controller.onSortOrderChanged(selectedValue);
            //     }
            //   },
            //   menu: MyContainer.bordered(
            //     borderRadiusAll: 10.r,
            ...
            //                       color: contentTheme.k7E7E7E)),
            //               TextSpan(
            //                   text: controller.sortOrder.value,
            //                   style: MyTextStyle.bodyLarge(
            //                       fontSize: 12.sp,
            //                       fontWeight: 600,
            //                       color: contentTheme.k142228))
            ...
            //     ),
            //   ),
            //   menuBuilder: (_) => buildSortingMenu(controller),
            // ),
...
//     final val = selectedValue as String?;
//     if (val == "A-Z" || val == "Z-A") {
//       controller.onSortOrderChanged(val!);
//     }
//   },
//   menu: MyContainer.bordered(
//     borderRadiusAll: 10.r,
...
//   onSelected: (value) {
//     controller.selectedSort.value = value;  // update selection
//     if (value == "A to Z") {
...
//             ),
        ...
        Expanded(
          child: Obx(() {
            if (controller.isLoading.value || controller.isSorting.value) {
              return const Center(
            ...
            return ListView.separated(
              padding: EdgeInsets.only(
                  left: 5, top: 15, right: MySpacing.fullWidth(context) * 0.04),
              shrinkWrap: true,
        ...
        Obx(() {
          final totalCount =
              controller.summaryCounts.value?.activeInstitutes ?? 0;

          // Hide only when NO DATA
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  // Page numbers (show even if totalPages == 1)
                  Row(
                    children: List.generate(
                      totalPages > 6 ? 6 : totalPages,
                      (index) {
                        if (totalPages > 6 && index == 4) {
                        ...
                        final pageNum = (index == 5 && totalPages > 6)
                            ? totalPages
                            : index + 1;
          ...
          Expanded(
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: MyText.bodyMedium(
                        "active", // you can make this dynamic if archived
                        style: GoogleFonts.inter(
                          fontSize: 10.sp,
                          fontWeight: FontWeight.w600,
                ...
                // MyText.bodySmall(
                //   institute.term ?? "No term available",
                //   style: GoogleFonts.inter(
                //     fontSize: 14.sp,
                //     fontWeight: FontWeight.w400,
                //     color: contentTheme.k142228,
  ...
  //   );
  // }
  //  Widget buildSortingMenu(AdminSchoolController controller) {
  //   return Container(
  //     color: Colors.white,
  //     child: Column(
  //       crossAxisAlignment: CrossAxisAlignment.start,
  //       children: ["A-Z", "Z-A"].map((option) {
  //         return GestureDetector(
  //           onTap: () {
  //             controller.onSortOrderChanged(option);
  //             Get.back(); // close popup menu
  //           },
  //           child: Container(
  //             color: controller.sortOrder.value == option
  ...
  //               option,
  //               style: TextStyle(
  //                 fontWeight: controller.sortOrder.value == option
  //                     ? FontWeight.bold
  //                     : FontWeight.normal,
  //               ),
  //             ),
  ...
  Widget buildSortingMenu(AdminSchoolController controller) {
    return Column(
      ...
      children: ["A-Z", "Z-A"].map((option) {
        final isSelected = controller.sortOrder.value == option;
        return GestureDetector(
          onTap: () {
            controller.onSortOrderChanged(option);
