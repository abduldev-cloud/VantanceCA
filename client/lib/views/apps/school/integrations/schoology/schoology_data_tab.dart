...
class SchoologyDataTab extends StatefulWidget {
  const SchoologyDataTab({super.key});

  @override
  State<SchoologyDataTab> createState() => _SchoologyDataTabState();
}

class _SchoologyDataTabState extends State<SchoologyDataTab>
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      return _buildTabContent(
          onSync, controller.middlewareTeachers.value, controller, "Teachers",
...
class TeacherEnrollmentsTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      return _buildTabContent(onSync, controller.teacherEnrollments.value,
          controller, "Teacher Enrollment", (newPage, query, isPageChange) {
...
class StudentTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      return _buildTabContent(
          onSync, controller.middlewareStudents.value, controller, "Students",
          (newPage, query, isPageChange) {
...
class StudentEnrollmentsTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      return _buildTabContent(onSync, controller.studentEnrollments.value,
          controller, "Student Enrollments", (newPage, query, isPageChange) {
...
class ClassTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      return _buildTabContent(
          onSync, controller.middlewareClasses.value, controller, "Class",
          (newPage, query, isPageChange) {
...
class AssignmentsTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      return _buildTabContent(onSync, controller.middlewareAssignments.value,
          controller, "Assignments", (newPage, query, isPageChange) {
...
class GradesTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      return _buildTabContent(
          onSync, controller.middlewareGrades.value, controller, "Grades",
          (newPage, query, isPageChange) {
