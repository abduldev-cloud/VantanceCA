...
class AppTheme {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    scrollbarTheme: ScrollbarThemeData(
        trackBorderColor: WidgetStateProperty.all(Color(0xff8E8E93)),
        radius: Radius.circular(8),
        thickness: WidgetStateProperty.all(8),
        thumbColor: WidgetStateProperty.all(Color(0xff8E8E93)),
        trackColor: WidgetStateProperty.all(Color(0xffFEFDFF))),

    /// Scaffold and Background color
    scaffoldBackgroundColor: Color(0xffFEFDFF),
    ...
    tabBarTheme: TabBarThemeData(indicatorColor: Color(0xffeeeeee)),
  );
